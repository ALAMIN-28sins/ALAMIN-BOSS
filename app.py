...
# ============================================
# Admin credentials change (email + password)
# ============================================
...
if __name__ == '__main__':
    ...
    print("\n" + "=" * 50)
    print("🚀 ALAMIN HOSTING - RAILWAY READY")
    print("=" * 50)
    print(f"📍 Port: {port}")
    print(f"📍 Data dir: {DATA_DIR}")
    print(f"📍 Admin email:    {DEFAULT_ADMIN_EMAIL}")
    print(f"📍 Admin password: {'[FROM ENV]' if os.environ.get('ADMIN_PASSWORD') else '[DEFAULT - CHANGE!]'}")
    print("=" * 50 + "\n")
